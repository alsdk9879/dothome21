...
<body>
                ...
                <article class="content-article">
                    <div class="boardType">
                        ...
                        <?php
                            ...
                            // echo $saerchKeyword, $saerchOption;
    ...
    //1~20번까지 나오게 : DESC LIMIT 0, 20      --> $page = 1   ($numView * $page) - $numView
    //21~40번까지 나오게 : DESC LIMIT 20, 20    --> $page = 2   ($numView * $page) - $numView
    //41~60번까지 나오게 : DESC LIMIT 40, 20    --> $page = 3   ($numView * $page) - $numView
    //61~80번까지 나오게 : DESC LIMIT 60, 20    --> $page = 4   ($numView * $page) - $numView
    //81~100번까지 나오게 : DESC LIMIT 80, 20   --> $page = 5   ($numView * $page) - $numView
